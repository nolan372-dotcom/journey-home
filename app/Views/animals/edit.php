...
<form action="/animals/<?= $animal['id'] ?>" method="post" class="bg-white rounded-lg border border-stone-200 p-6 space-y-5 max-w-2xl">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div>
            ...
            <select id="a-size" name="size" class="w-full rounded-lg border border-stone-300 bg-white px-3 py-2 text-sm text-stone-800 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400">
        ...
        <div class="sm:col-span-2">
            ...
            <textarea id="a-notes" name="notes" rows="3"
                class="w-full rounded-lg border border-stone-300 bg-white px-3 py-2 text-sm text-stone-800 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400"><?= esc($animal['notes'] ?? '') ?></textarea>
        </div>
    </div>
